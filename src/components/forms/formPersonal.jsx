...
const FormPersonal = () => {
    return (
        <form className="grid grid-cols-2 gap-4">
            ...
            <div>
                <label className="block text-[#217D58] font-medium mb-1" htmlFor="cargo">Cargo</label>
                <input
                    type="text"
                    id="cargo"
                    name="cargo"
            ...
            <div>
                <label className="block text-[#217D58] font-medium mb-1" htmlFor="numero">Número</label>
                <input
                    type="tel"
                    id="numero"
                    name="numero"
